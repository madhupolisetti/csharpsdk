  ...
  public  class GroupCall:GenericResult
    {
        ...
        private string _StartGropCallOnEnter = string.Empty;
        ...
        public string StartGropCallOnEnter
        {
            get { return this._StartGropCallOnEnter; }
            set { this._StartGropCallOnEnter = value; }
        }
        ...
        public List<Participatants> Participatants { get; set; }
