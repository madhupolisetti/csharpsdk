...
namespace SMSCountryApi
{
    public  class GetCreateNewGroup
    {
      ...
      private string _StartGroupCallOnEnt = string.Empty;
      ...
      public string StartGroupCallOnEnt
      {
          get { return this._StartGroupCallOnEnt; }
          set { this._StartGroupCallOnEnt = value; }
      }
